...
CREATE TABLE DICHVUCLS(
	...
	MAPHIEUKHAM INT,
	TINHTRANG BIT DEFAULT 0 , -- THÊM TÌNH TRẠNG CỦA DỊCH VỤ DATY - 11/12
	NGUOITHU INT DEFAULT 3, -- THÊM MÃ CỦA NG THU TIỀN  DATY - 11/12
	TONGCONG MONEY
)
GO
...
CREATE TABLE DONTHUOC(
	...
	TINHTRANG BIT DEFAULT 0, -- THÊM CỘT TINHTRANG - DATY-11/12
	NGUOITHU INT DEFAULT 3, -- THÊM CỘT NGƯỜI THU - DATY - 11/12
	TONGCONG MONEY
)
GO
